...
This design violates DIP A: High-level modules should not depend on low-level 
...
We make a Connection interface:
"""
...
"""
So now, no matter the type of Http connection service passed to Http 
it can easily connect to a network 
